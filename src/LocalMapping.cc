    ...
    for(size_t i = 0; i<TotalvMatchedIndices.size() -1; i++)
    {
        ...
        for(size_t j = i+1; j<TotalvMatchedIndices.size(); j++)
        {
            ...
            {   
                ...
                cv::line(pic_Temp2, lp11r, lp12r, Scalar(255,255,0), 2, CV_AA);
                cv::line(pic_Temp2, lp21r, lp22r, Scalar(255,255,0), 2, CV_AA);
                cv::line(pic_Temp2, lp31r, lp32r, Scalar(255,255,0), 2, CV_AA);
                ...
                cv::line(pic_Temp1, lp11, lp12, Scalar(255,0,255), 1, CV_AA);
                cv::line(pic_Temp1, lp21, lp22, Scalar(255,0,255), 1, CV_AA);
                cv::line(pic_Temp1, lp31, lp32, Scalar(255,0,255), 1, CV_AA);

                cv::line(pic_Temp1, Point_1, Point_2, Scalar(0,255,255), 1, CV_AA);
                cv::line(pic_Temp1, Point_2, Point_3, Scalar(0,255,255), 1, CV_AA);

                //cv::line(pic_Temp2, Point_1, Point_2, Scalar(0,255,255), 1, CV_AA);
                //cv::line(pic_Temp2, Point_2, Point_3, Scalar(0,255,255), 1, CV_AA);
