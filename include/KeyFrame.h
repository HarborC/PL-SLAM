...
class KeyFrameDatabase;
    class MapLine;  //自己添加的，仿照MapPoint
...
public:
    ...
    long unsigned int mnId;             //当前KeyFrame的ID号
    const long unsigned int mnFrameId;  //该KeyFrame是由哪个Frame初始化得到的
...
protected:
    ...
    std::vector< std::vector <std::vector<size_t> > > mGridForLine;
